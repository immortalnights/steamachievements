...
module.exports = class Database {
	...
	// player resynchronization methods
	resetPendingResynchronizations()
	{
		const collection = this.collection(PLAYER_COLLECTION_NAME);
	...
	// find and modify player record. Set state to 'pending'
	// return document is _before_ the modification
	triggerResynchronizationForPlayer(playerId)
	{
		const collection = this.collection(PLAYER_COLLECTION_NAME);
